...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/automation-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-automation-core:");
...
console.log("Documentation check passed for gutu-plugin-automation-core.");
